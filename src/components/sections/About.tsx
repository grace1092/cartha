    ...
    <section id="about" className="py-20 section-about">
      <div className="container-modern">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-xl text-body mb-12 leading-relaxed opacity-0 animate-fade-in-delay">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16">
            <div className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 opacity-0 animate-fade-in-delay-2">
              <div className="w-16 h-16 bg-gradient-to-r from-primary-500 to-purple-600 rounded-xl flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 opacity-0 animate-fade-in-delay-3">
              ...
              <h3 className="text-2xl font-bold mb-4 text-heading">Our Vision</h3>
              <p className="text-body leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="opacity-0 animate-fade-in-delay-4">
              <h3 className="text-3xl font-bold mb-6 text-heading">Our Story</h3>
            ...
            <div className="bg-gradient-to-br from-primary-500 to-purple-600 rounded-2xl p-8 text-white opacity-0 animate-fade-in-delay-5">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary-100 text-sm">Every feature is built with the therapist-client relationship in mind</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-300 flex-shrink-0 mt-1" />
                  <div>
                    ...
                    <p className="text-primary-100 text-sm">HIPAA compliance and enterprise-grade security are non-negotiable</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-300 flex-shrink-0 mt-1" />
                  <div>
                    ...
                    <p className="text-primary-100 text-sm">We evolve with the changing needs of mental health professionals</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold mb-6 text-heading opacity-0 animate-fade-in-delay-6">
              Meet Our Team
            </h3>
            <p className="text-xl text-body max-w-3xl mx-auto opacity-0 animate-fade-in-delay-7">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Team Member 1 */}
            <div className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 opacity-0 animate-fade-in-delay-8">
              <div className="w-20 h-20 bg-gradient-to-r from-primary-500 to-purple-600 rounded-full flex items-center justify-center mb-6 mx-auto">
                <Users className="w-10 h-10 text-white" />
              </div>
              <h4 className="text-xl font-bold text-center mb-2 text-heading">Dr. Sarah Chen</h4>
              <p className="text-primary-600 text-center mb-4 font-semibold">Chief Medical Officer</p>
            ...
            {/* Team Member 2 */}
            <div className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 opacity-0 animate-fade-in-delay-9">
              ...
              <h4 className="text-xl font-bold text-center mb-2 text-heading">Michael Rodriguez</h4>
              <p className="text-primary-600 text-center mb-4 font-semibold">Chief Technology Officer</p>
              <p className="text-body text-center text-sm leading-relaxed">
            ...
            {/* Team Member 3 */}
            <div className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 opacity-0 animate-fade-in-delay-10">
              <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-primary-600 rounded-full flex items-center justify-center mb-6 mx-auto">
                <Shield className="w-10 h-10 text-white" />
              </div>
              <h4 className="text-xl font-bold text-center mb-2 text-heading">Dr. Emily Watson</h4>
              <p className="text-primary-600 text-center mb-4 font-semibold">Head of Security & Compliance</p>
              <p className="text-body text-center text-sm leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold mb-6 text-heading opacity-0 animate-fade-in-delay-11">
              Our Values
            </h3>
            <p className="text-xl text-body max-w-3xl mx-auto opacity-0 animate-fade-in-delay-12">
              The principles that guide everything we do in serving the mental health community.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 opacity-0 animate-fade-in-delay-13">
              ...
              <h4 className="text-lg font-bold mb-2 text-heading">Privacy & Security</h4>
              <p className="text-body text-sm">
                Uncompromising commitment to protecting client data and maintaining the highest security standards.
              </p>
            </div>

            <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 opacity-0 animate-fade-in-delay-14">
              <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mb-4">
                <Heart className="w-6 h-6 text-white" />
              </div>
              <h4 className="text-lg font-bold mb-2 text-heading">Client-Centered</h4>
              <p className="text-body text-sm">
                Every decision we make prioritizes the well-being and success of therapists and their clients.
              </p>
            </div>

            <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 opacity-0 animate-fade-in-delay-15">
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-lg flex items-center justify-center mb-4">
                <Award className="w-6 h-6 text-white" />
              </div>
              <h4 className="text-lg font-bold mb-2 text-heading">Excellence</h4>
              <p className="text-body text-sm">
                We strive for excellence in every aspect of our platform, from design to customer support.
              </p>
            </div>

            <div className="bg-card rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 opacity-0 animate-fade-in-delay-16">
              <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg flex items-center justify-center mb-4">
                <Users className="w-6 h-6 text-white" />
              </div>
              <h4 className="text-lg font-bold mb-2 text-heading">Community</h4>
              <p className="text-body text-sm">
