...
export default function ClientManagementDashboard({ onClose }: ClientManagementDashboardProps) {
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-heading">Client Management Dashboard</h3>
              <div className="flex items-center space-x-2">
                <select 
                  value={selectedClient}
                  onChange={(e) => setSelectedClient(e.target.value)}
                  className="border border-input-border rounded-lg px-3 py-2 text-sm bg-input text-body"
                >
                  {clients.map(client => (
            ...
            <div className="bg-card rounded-lg p-6 mb-6 border border-card-border">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <h4 className="font-semibold text-heading">{selectedClientData?.name}</h4>
                  <p className="text-sm text-body">{selectedClientData?.age} years old</p>
                  <p className="text-sm text-body">{selectedClientData?.diagnosis}</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2">
                  ...
                  <p className="text-sm text-body">Last: {selectedClientData?.lastSession}</p>
                  <p className="text-sm text-body">Next: {selectedClientData?.nextSession}</p>
                </div>
                <div>
                  <div className="flex items-center space-x-2">
          ...
          {currentView === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-card rounded-lg border border-card-border p-6">
                <h4 className="font-semibold text-heading mb-4">Outcome Measures</h4>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-body">PHQ-9 (Depression)</span>
                    <div className="flex items-center space-x-2">
              ...
              {/* Treatment Goals */}
              <div className="bg-card rounded-lg border border-card-border p-6">
                <h4 className="font-semibold text-heading mb-4">Treatment Goals</h4>
                <div className="space-y-3">
                  {treatmentGoals.map((goal) => (
                    <div key={goal.id} className="border-l-4 border-blue-500 pl-3">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm font-medium text-heading">{goal.goal}</span>
          ...
          {currentView === 'progress' && (
            <div className="bg-card rounded-lg border border-card-border p-6">
              <h4 className="font-semibold text-heading mb-4">Progress Tracking</h4>
