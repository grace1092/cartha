...
export const metadata = {
  title: 'Pricing - Cartha | Professional Healthcare Practice Management',
  description: 'Choose the perfect plan for your practice: Solo Practice ($49), Group Practice ($149), Enterprise ($499). HIPAA-compliant, secure, and trusted by healthcare professionals.',
  openGraph: {
    title: 'Pricing - Cartha | Professional Healthcare Practice Management',
    description: 'Choose the perfect plan for your practice: Solo Practice ($49), Group Practice ($149), Enterprise ($499). HIPAA-compliant, secure, and trusted by healthcare professionals.',
    type: 'website',
            ...
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="scroll-reveal" style={{ animationDelay: '0.2s' }}>
                <p className="body-lg max-w-3xl mx-auto mb-12">
                  Streamline your therapy practice with intelligent session notes, automated follow-ups, 
                  and comprehensive client dashboards. Transform your practice with intelligent automation, 
